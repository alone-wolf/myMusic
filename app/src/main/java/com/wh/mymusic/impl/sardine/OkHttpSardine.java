package com.wh.mymusic.impl.sardine;
...
public class OkHttpSardine implements Sardine {
    ...
    public OkHttpSardine() {
        client = new OkHttpClient.Builder().sslSocketFactory(createSSLSocketFactory(), mMyTrustManager).build();
    }
    ...
    public void setCredentials(String username, String password, boolean isPreemptive) {
        ...
        if (isPreemptive) {
            builder.addInterceptor(new OkHttpSardine.AuthenticationInterceptor(username, password));
        } else {
