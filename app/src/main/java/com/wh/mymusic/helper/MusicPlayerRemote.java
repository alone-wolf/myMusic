...
//
//    @Nullable
//    public static PlayService musicService;
//
...
//
//        if (contextWrapper.bindService(new Intent().setClass(contextWrapper, PlayService.class), binder, Context.BIND_AUTO_CREATE)) {
...
//                setShuffleMode(PlayService.SHUFFLE_MODE_NONE);
//            }
//        }
//    }
//
...
//            setShuffleMode(PlayService.SHUFFLE_MODE_SHUFFLE);
//        }
//    }
//
