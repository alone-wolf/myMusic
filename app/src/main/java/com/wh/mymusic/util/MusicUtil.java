...
public class MusicUtil {
    private static String TAG = "WH_MusicUtil";
...
//
//        return com.kabouzeid.gramophone.util.MusicUtil.buildInfoString(
//            com.kabouzeid.gramophone.util.MusicUtil.getAlbumCountString(context, albumCount),
//            com.kabouzeid.gramophone.util.MusicUtil.getSongCountString(context, songCount)
//        );
//    }
...
//        return com.kabouzeid.gramophone.util.MusicUtil.getSongCountString(context, songCount);
//    }
...
//
//        return com.kabouzeid.gramophone.util.MusicUtil.buildInfoString(
//            com.kabouzeid.gramophone.util.MusicUtil.getSongCountString(context, songs.size()),
//            com.kabouzeid.gramophone.util.MusicUtil.getReadableDurationString(duration)
//        );
//    }
